...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor implements BeanDefinition, Cloneable {
    ...
    /**
     * false时，容器在自动装配时，将不考虑该bean，不会作为其他bean的装配候选者，但是本身还可以注入其他bean
     */
    ...
    /**
     * 宽松的构造解析标记，默认为true。false时无法准确定位构造器时会抛出异常
     */
    ...
    /**
     * 记录重写 lookup-method、replace-method
     */
